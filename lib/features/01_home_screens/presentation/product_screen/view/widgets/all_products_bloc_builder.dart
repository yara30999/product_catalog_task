...
import 'package:products_app/features/01_home_screens/presentation/product_screen/view/widgets/products_list_view.dart';
      ...
      builder: (context, state) {
        switch (state) {
          ...
          case AllProductSuccess():
            return ProductsListView(state.products);
